...
export default class Debugger {
    constructor (options) {
        ...
        this.debuggerView.on('removeBreakpoint', this.toggleBreakpoint.bind(this));
        this.debuggerView.on('addBreakpoint', this.toggleBreakpoint.bind(this));
    ...
    updateBreakpoints () {
        this.connectionInstanse.createBreakpoints(breakpointMgr.getList().map(brk => ({
            ...
            if (this.debuggerView) {
                console.log(serverBreakpoints);
                this.debuggerView.updateBreakpoints(serverBreakpoints);
            }
