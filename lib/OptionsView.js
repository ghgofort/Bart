...
export default class OptionsView {
    constructor (currentOptions = {}) {
        ...
        this.folders = currentOptions.folders || [];
        this.el =
    ...
    createFolderCheckbox(dir) { //eslint-disable-line
        const folder = //eslint-disable-line
            <li>
                <div class="bart-folderlist-item">
                    <input type='checkbox' class='' value='name'/>
                </div>
            </li>;
    }
    ...
    createCartridgeCheckbox (dir, projectDir) {
        ...
        const inp = ele.getElementsByClassName('bart-cartridgelist-checkbox');
